...
> [!IMPORTANT]
>
> Historical plan, completed and superseded by the LTX 2.5 stack. The current matrix is CUDA 13.0.2 primary and CUDA 12.8.1 fallback; use [`docker-bake.hcl`](../../docker-bake.hcl) and the [deployment guide](../deployment.md) as the source of truth.
